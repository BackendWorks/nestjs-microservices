...
{{ include "nestjs-microservices.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "nestjs-microservices.selectorLabels" -}}
...
*/}}
{{- define "nestjs-microservices.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nestjs-microservices.fullname" .) .Values.serviceAccount.name }}
{{- else }}
